...
public interface EvChargingService {
	...
	public Optional<List<Charger>> getChargersOfStationAndType(String campus, String city, ChargerType chargerType) throws EvChargingException; // more filtered -> Admin Actions
	
	//User booking 
	public LocalDate getNextAvailableBookingDate(ChargerType selectedChargerType,LocalDate selectedDate, String campus, String city)throws EvChargingException;
	
	public Optional<List<Booking>> searchSlots(LocalDate forDate, ChargerType selectedChargerType,String campus, String city) throws EvChargingException;
